...
def main():
    ...
    parser.add_argument('-f', '--from-l3agent', help='l3agent uuid')
    parser.add_argument('-t', '--to-l3agent', help='l3agent uuid')
    ...
    if not (args.from_l3agent) or not (args.to_l3agent):
        print
        print "ERROR: parameters --from-l3agent and --to-l3agent must be specified."
        print
        parser.print_help()
        sys.exit(1)
